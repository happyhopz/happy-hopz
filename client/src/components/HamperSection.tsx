                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                        {hampers.map((hamper: any, index: number) => (
                            ...
                            >
                                <div className="relative aspect-square w-full mb-4 overflow-hidden rounded-2xl bg-white flex items-center justify-center border border-gray-100 p-2 shadow-sm">
                                    <img
                                        src={hamper.images[0]}
                                        alt={hamper.name}
