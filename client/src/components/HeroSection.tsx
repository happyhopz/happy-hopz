      ...
      <div className="container mx-auto px-4 py-0 lg:py-16 relative z-10">
        ...
        <div className="flex flex-col items-center justify-between lg:hidden min-h-screen">
          ...
          <div className="text-center px-4 w-full">
            <h1 className="text-3xl sm:text-4xl font-fredoka font-black leading-tight animate-fade-up opacity-0 delay-100 tracking-tighter text-[#26252b] drop-shadow-sm">
              {content.title}
            </h1>

            <p className="mt-3 text-sm sm:text-base animate-fade-up opacity-0 delay-200 italic text-[#26252b] font-nunito max-w-sm mx-auto">
              {content.subtitle}
            </p>
          </div>
        ...
        <div className="hidden lg:flex flex-row items-center gap-12">
          ...
          <div className="flex-1 text-left">
            ...
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-fredoka font-black leading-tight animate-fade-up opacity-0 delay-100 tracking-tight !text-black">
              {content.title}
            </h1>

            <p className="mt-6 text-xl md:text-2xl font-nunito max-w-xl animate-fade-up opacity-0 delay-200 italic !text-black">
              {content.subtitle}
            </p>
