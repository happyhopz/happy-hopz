...
const ProductCard = ({
    ...
    return (
        <div className="relative">
            ...
            >
                {/* Product Image */}
                <div className="relative aspect-[4/5] flex items-center justify-center mb-3 md:mb-6 overflow-hidden rounded-2xl border border-muted/30 bg-white shadow-sm p-4">
                    <img
