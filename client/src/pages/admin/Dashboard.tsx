                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                <div className="p-4 bg-blue-50/60 border border-blue-100 rounded-xl text-center">
                                    ...
                                    <p className="text-3xl font-fredoka font-bold text-blue-800">{visitorStats?.todayRealVisitors ?? '—'}</p>
                                    <p className="text-[10px] text-blue-500 mt-0.5" title="Human count (Distinct IP/Email)">real unique visitors</p>
                                ...
                                <div className="p-4 bg-indigo-50/60 border border-indigo-100 rounded-xl text-center">
                                    ...
                                    <p className="text-3xl font-fredoka font-bold text-indigo-800">{visitorStats?.weekRealVisitors ?? '—'}</p>
                                    <p className="text-[10px] text-indigo-500 mt-0.5" title="Human count (Distinct IP/Email)">real unique visitors</p>
                                ...
                                <div className="p-4 bg-violet-50/60 border border-violet-100 rounded-xl text-center">
                                    ...
                                    <p className="text-3xl font-fredoka font-bold text-violet-800">{visitorStats?.monthRealVisitors ?? '—'}</p>
                                    <p className="text-[10px] text-violet-500 mt-0.5" title="Human count (Distinct IP/Email)">real unique visitors</p>
                                ...
                                <div className="p-4 bg-purple-50/60 border border-purple-100 rounded-xl text-center">
                                    ...
                                    <p className="text-3xl font-fredoka font-bold text-purple-800">{visitorStats?.totalRealVisitors ?? '—'}</p>
                                    <p className="text-[10px] text-purple-500 mt-0.5" title="Human count (Distinct IP/Email)">real unique visitors</p>
